...
// Категория работ в SR/EN формах выбирается на своём языке, а бот принимает только
// канонические русские названия (specialties в config.yaml). Без этого маппинга
// заявки с сербской и английской форм бот отбраковывает (на email они всё равно уходят).
// RU-значения уже канонические — проходят через fallback в sendLeadToBot без записи здесь.
// Ключи должны совпадать с value в <select name="service"> на /sr/ и /en/.
const BOT_SERVICE_MAP = {
    // SR — основная аудитория, значения из формы на /sr/ и /sr/novi-sad/
    Vodoinstalacije: 'Сантехника', Elektrika: 'Электрика', Popravke: 'Ремонт',
    'Nameštaj': 'Мебель', Selidbe: 'Грузчики', 'Čišćenje': 'Клининг', Ostalo: 'Другое',
    // EN
