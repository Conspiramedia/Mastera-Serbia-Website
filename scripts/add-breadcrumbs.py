...
def main():
    ...
    #
    # Хабы городов (/ru/novi-sad/ и пара) когда-то унаследовали эту же
    # крошку и показывали «Pravi Majstor / Русский» на странице Нови-Сада.
    # Сейчас у них путь «Главная → Нови-Сад», проставленный вручную, и
    # второй проход их не трогает — крошки там уже есть.
